...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '3306', 'dbname' => 'symfony', 'user' => 'root', 'password' => 'root', 'unix_socket' => ($this->targetDirs[5].'/tmp/mysql/mysql.sock'), 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Exam/TodoBundle/Resources/config/doctrine') => 'Exam\\TodoBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Exam\\TodoBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ExamTodoBundle' => 'Exam\\TodoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_19d4e66ca84945833a579c2cd990f1d30b721f678d7f0c2e8a46a20e428bf938');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Exam/TodoBundle/Resources/views'), 'ExamTodo');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fff696b5f77925ae91cca58d573cf9e0301b8ed8');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ExamTodoBundle' => 'Exam\\TodoBundle\\ExamTodoBundle',
            ...
            'locale' => 'en',
            'secret' => 'fff696b5f77925ae91cca58d573cf9e0301b8ed8',
            ...
            'kernel.secret' => 'fff696b5f77925ae91cca58d573cf9e0301b8ed8',
